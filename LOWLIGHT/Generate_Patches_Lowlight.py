...
parser.add_argument('--src_dir', dest='src_dir', default='./lol_dataset/our485/high', help='dir of data')
...
def generate_patches(isDebug=False):
    ...
    count = 0
    filepaths = glob(args.src_dir + '/*.png')
    ...
    np.save(os.path.join(args.save_dir, "high_pats_rgb"), inputs)
